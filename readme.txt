...
The development repository is on [GitHub](https://github.com/threadi/external-files-from-google-drive/).
...
1. Upload "external-files-from-google-drive" to the "/wp-content/plugins/" directory.
