...
namespace ExternalFilesFromGoogleDrive;
...
class GoogleDrive extends Service_Base implements Service {
	...
	public function add_protocol( array $protocols ): array {
		...
		array_unshift( $protocols, 'ExternalFilesFromGoogleDrive\GoogleDrive\Protocol' );
	...
	private function get_real_redirect_uri(): string {
		 ...
		 */
		return apply_filters( 'efmlgd_google_drive_real_redirect_uri', $real_redirect_uri );
	}
	...
	private function get_state(): string {
		 ...
		 */
		return apply_filters( 'efmlgd_google_drive_state', $state );
	}
	...
	private function get_redirect_uri(): string {
		 ...
		 */
		return apply_filters( 'efmlgd_google_drive_redirect_uri', $redirect_uri );
	}
	...
	public function initiate_connection(): void {
		 ...
		 */
		$params = apply_filters( 'efmlgd_google_drive_connector_params', $params );
	...
	public function cli(): void {
		\WP_CLI::add_command( 'eml', 'ExternalFilesFromGoogleDrive\GoogleDrive\Cli' );
	}
	...
	public function get_directory_listing( string $directory ): array {
		 ...
		 */
		$query = apply_filters( 'efmlgd_google_drive_query_params', $query, $directory );
		 ...
		 */
		$files = apply_filters( 'efmlgd_google_drive_files', $files );
		...
		foreach ( $files as $file_obj ) {
			 ...
			 */
			if ( apply_filters( 'efmlgd_google_drive_hide_file', $false, $file_obj, $directory ) ) {
				continue;
			}
	...
	private function get_refresh_token_url(): string {
		 ...
		 */
		return apply_filters( 'efmlgd_google_drive_refresh_uri', $refresh_uri );
	}
	...
	public function get_user_settings(): array {
		 ...
		 */
		return apply_filters( 'efmlgd_service_google_drive_user_settings', $list );
	}
	...
	public function get_public_url_for_file_id( string $file_id ): string {
		 ...
		 * @param string $file_id The file ID.
		 */
		return apply_filters( 'efmlgd_service_google_drive_public_url', $url, $file_id );
	}
