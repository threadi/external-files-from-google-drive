...
class Init {
	...
	public function init(): void {
		...
		add_filter( 'wp_consent_api_registered_' . plugin_basename( EFMLGD_PLUGIN ), array( $this, 'register_consent_api' ) );
	}
	...
	public function remove_service_plugin( array $plugins ): array {
		unset( $plugins['external-files-from-google-drive'] );
		return $plugins;
	}
	...
	public function add_configuration( array $configurations ): array {
		...
		$configurations[] = '\ExternalFilesFromGoogleDrive\Plugin\Configuration';
